package com.smart.sotral.Shared.jwt.components;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.smart.sotral.Shared.advice.HttpErrorResponse;
...
public class JwtAccessDeniedHandler implements AccessDeniedHandler {
    private static final String ACCESS_DENIED_MESSAGE = "Access Denied: Vous n'avez pas accès à cette ressource";
    @Override
