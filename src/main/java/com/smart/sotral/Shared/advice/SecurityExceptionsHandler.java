package com.smart.sotral.Shared.advice;

import com.smart.sotral.Shared.exceptions.UserAlreadyExistException;
import com.smart.sotral.Shared.exceptions.UserNotFoundException;
...
public class SecurityExceptionsHandler  {
    ...
    @ExceptionHandler({NoResultException.class, UserNotFoundException.class, RoleNotFoundException.class})
